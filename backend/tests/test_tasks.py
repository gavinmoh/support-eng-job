...
class TestTaskManager(unittest.TestCase):
    ...
    def test_add_task(self):
        ...
        self.assertEqual(self.manager.tasks[1].title, "Write code")
    ...
    def test_update_status(self):
        ...
        self.assertEqual(self.manager.tasks[1].status, "completed")
        self.assertEqual(self.manager.tasks[2].status, "pending")
    ...
    def test_high_priority_tasks(self):
        ...
        self.assertEqual(len(high_tasks), 2,
                         "Should find both high-priority tasks")
